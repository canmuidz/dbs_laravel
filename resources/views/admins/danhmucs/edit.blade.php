                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" id="anh_danh_muc" name="anh_danh_muc" class="form-control @error('anh_danh_muc') is-invalid @enderror">
                                        @error('anh_danh_muc')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <img id="img_danh_muc" src="{{ Storage::url($danhMuc->anh_danh_muc) }}" alt="Hình ảnh" style=" width:200px; height: auto;">
