                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        value="{{ old('tieu_de_bai_viet', $baiviet->tieu_de_bai_viet) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        value="{{ old('ngay_dang', $baiviet->ngay_dang) }}">
                                        @error('ngay_dang')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        rows="3" placeholder="Mô tả ngắn">{{ old('mo_ta_ngan', $baiviet->mo_ta_ngan) }}</textarea>
                                        @error('mo_ta_ngan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <div class="mt-2">
                                            <img id="imagePreview" src="{{ $baiviet->anh_bai_viet ? Storage::url($baiviet->anh_bai_viet) : '#' }}" 
                                             alt="Hình ảnh preview" style="width:200px;">
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Set initial content
        var oldContent = `{!! old('noi_dung', $baiviet->noi_dung) !!}`;
