    ...
    <section class="ftco-section ftco-no-pb">
        <div class="container">
            <div class="row">
                <div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url('{{asset('assets/client/images/about.jpg')}} ')  ;">
                </div>
                            ...
                            <div class="testimony-wrap py-4">
                                <div class="text">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="pl-3">{{asset('assets/client/images/person_1.jpg')}}
